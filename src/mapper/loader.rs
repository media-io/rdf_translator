          ...
          for found in founds.iter() {
            match *found {
              ...
              &Value::Number(ref content) => {
                tmp_results.push(template.clone() + &content.as_f64().unwrap().to_string());
              },
              _ => {},
            }
          }
...
fn test_parse_label_null() {
  ...
  assert_eq!(result, vec![
    "prefix666suffix".to_string(),
    "prefix999suffix".to_string(),
  ]);
